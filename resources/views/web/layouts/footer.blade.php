<footer>
    <div class="container">
        {{-- <div class="row text-white p-3 m-3 bg-dark">
            ...
            <p>
                We care about our players and want to ensure that any time spent with us stays fun. Betting should always be within your means and not negatively impacting you either financially or socially. Borrowing money to play, spending above your budget or using money allocated for other purposes is not only unwise but can lead to significant problems for you and others around you. We want you to enjoy playing on Mybola66, so bet responsibly and have fun!
            </p>
        </div> --}}
        <div class="line"></div>
        <div class="row">
    ...
    <div class="foo_copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Copyright &copy; 2019 Mybola66. All Rights Reserved.
                </div>
            </div>
        </div>
    </div>
